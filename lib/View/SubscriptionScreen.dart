              ...
              children: [
                ...
                Container(
                  ...
                  child: Obx(() => ElevatedButton(
                        onPressed: StripeServices.instance.isLoading.value ||
                                ...
                                if (user != null) {
                                  ...
                                  switch (_currentIndex) {
                                    ...
                                    case 2:
                                      voucherId = 5;
                                      amount = 7.99 *
                                          4; // For 1 month, 5.99 per week
                                      break;
                                    case 3:
                                      voucherId = 6;
                                      amount = 6.99 *
                                          4 *
                                          3; // For 3 months, 4.99 per week
                                      break;
                                    default:
                                      voucherId = 3;
                                      amount = 5.99;
                                      ...
                                      try {
                                        ...
                                        if (paymentController
                                          ...
                                          Get.snackbar("Success",
                                              "Payment and subscription successful!");
                                  ...
                                  await StripeServices.instance.startPurchase(
                                      amount, purchaseHook, context);
                ...
                Padding(
                  ...
                  child: Text(
                    'Your subscription will auto-renew for the same price and package length until you cancel via App Store settings, and you areee to out terms.',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 10,
                      color: Colors.grey,
